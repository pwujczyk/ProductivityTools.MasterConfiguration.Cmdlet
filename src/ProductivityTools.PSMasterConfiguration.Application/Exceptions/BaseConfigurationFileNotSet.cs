...
namespace ProductivityTools.PSMasterConfiguration.Application.Exceptions
{
    public class BaseConfigurationFileNotSet : Exception
    {

        private static string Mesage = "Please setup application name using Set-MasterConfigurationBaseConfigurationFile";
